        ...
        <tbody>
          ...
          <tr>
            ...
            <td><span class="text-ellipsis">
                ...
                ?>
                    <a href="{{URL::to('/unactive-brand-product/'.$brand_pro->brand_id)}}"><span class="fa-thumbs-styling fa fa-eye-slash"> </span></a>
                <?php
                    }else{
                ?>
                    <a href="{{URL::to('/active-brand-product/'.$brand_pro->brand_id)}}"><span class="fa-thumbs-styling fa-solid fa-eye"> </span></a>
                <?php
                }
                ?>
