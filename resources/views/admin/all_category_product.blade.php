        ...
        <tbody>
          ...
          <tr>
            ...
            <td><span class="text-ellipsis">
                ...
                ?>
                    <a href="{{URL::to('/unactive-category-product/'.$cate_pro->category_id)}}"><span class="fa-thumbs-styling fa fa-eye-slash"> </span></a>
                <?php
                    }else{
                ?>
                    <a href="{{URL::to('/active-category-product/'.$cate_pro->category_id)}}"><span class="fa-thumbs-styling fa-solid fa-eye"> </span></a>
                <?php
                }
                ?>
            ...
            <td><span class="text-ellipsis">16/09/2022</span></td>
            <td>
