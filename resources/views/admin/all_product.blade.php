        ...
        <tbody>
          ...
          <tr>
            ...
            <td><span class="text-ellipsis">
                ...
                ?>
                    <a href="{{URL::to('/unactive-product/'.$pro->product_id)}}"><span class="fa-thumbs-styling fa fa-eye-slash"> </span></a>
                <?php
                    }else{
                ?>
                    <a href="{{URL::to('/active-product/'.$pro->product_id)}}"><span class="fa-thumbs-styling fa-solid fa-eye"> </span></a>
                <?php
                }
                ?>
